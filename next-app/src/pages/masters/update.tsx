...
import {
    ...
    optionsLength_of_study,
    optionsMethod_of_application,
    optionsMoodle_profile_created,
    optionsPaid_ksk,
    optionsProfessional_qualification,
...
export default function Update({ id, returnUrl }: IStudentGetData) {
        ...
        const fetchStudent = async () => {
            try {
                const response = await axios.get(
                    `/api/students/masters/get_one?id=${id}`
                );
                console.log(response.data.student);
                const data: IStudentGetData = response.data.student;
        ...
        <PageConfig>
            <StudentFormWrapper>
                ...
                <StudentFormUpdateStudent>
                    ...
                    <FormControl variant="standard">
                        <InputLabel id="demo-simple-select-label">
                            Професионално направление / квалификация
                        </InputLabel>
                        <Select
                            value={
                                studentFetchedData.professional_qualification ||
                                ""
                            }
                    ...
                    <FormControl variant="standard">
                        <InputLabel id="demo-simple-select-label">
                            Потвърждение от Нацид
                        </InputLabel>
                        <Select
                            value={
                                studentFetchedData.confirmation_by_nacid || ""
                            }
                    ...
                    <FormControl variant="standard">
                        <InputLabel id="demo-simple-select-label">
                            Продължителност на обучение и дали съкращава
                        </InputLabel>
                        <Select
                            value={studentFetchedData.length_of_study || ""}
                    ...
                    <FormControl variant="standard">
                        ...
                        <Select
                            value={studentFetchedData.cohort_in_moodle || ""}
                    ...
                    <FormControl variant="standard">
                        ...
                        <Select
                            value={studentFetchedData.sent_faculty_number || ""}
                            name="sent_faculty_number"
                            onChange={handleSelectChange}
                        >
