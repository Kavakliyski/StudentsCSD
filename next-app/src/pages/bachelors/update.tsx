        ...
        <PageConfig>
            <StudentFormWrapper>
                ...
                <StudentFormUpdateStudent>
                    ...
                    <FormControl variant="standard">
                        <InputLabel id="demo-simple-select-label">Удостоверение от РУО</InputLabel>
                        <Select value={studentFetchedData.certificate_from_ruo || ''} name="certificate_from_ruo" onChange={handleSelectChange}>
